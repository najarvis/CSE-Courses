public class Sorting {
	private static <T extends Comparable<? super T>>
					int indexOfSmallest(T [] ary, int start)
	{
    ...
    public static <T extends Comparable<? super T>>
    				void quickSort(T [] ary)
    {
    	quickSort(ary, 0, ary.length-1);
    }
    public static <T extends Comparable<? super T>>
    				void quickSort(T [] ary, int from, int to)
    {
    	if (from >= to)
    		return;
    ...
    private static <T extends Comparable<? super T>>
    				int partition(T [] a, int from, int to)
    {
    	T pivot = a[from];
    	int i = from-1;
    	int j = to+1;
