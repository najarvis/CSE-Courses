public class Searching {
	 ...
	 */
	public static <T extends Comparable<? super T>>
					int linearSearchOfSortedArray(T[] ary, T key) {
		int i;
	 ...
	 */
	public static <T extends Comparable<? super T>>
				int recursiveBinarySearch(T[] ary, int lo, int hi, T key) {
		int v = -1;
		if (lo <= hi) {
			int mid = (lo + hi) / 2;
	...
	public static <T extends Comparable<? super T>>
					int recursiveBinarySearch(T[] ary, T key) {
		int n = ary.length;
