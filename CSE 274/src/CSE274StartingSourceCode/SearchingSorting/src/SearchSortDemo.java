...
public class SearchSortDemo {
	enum SearchType { Linear, LinearSorted, BSearch, RecursiveBSearch, Arrays };
	enum SortType { Insertion, Selection, Merge, Quick, Arrays, ArraysReversed };
	
	private static <T extends Comparable<? super T>>
					void doSearch(SearchType type, T [] ary, T key)
	{
		...
		System.out.printf("%s (%f seconds) ", type.toString(),
	...
	{	
		...
		//ary = DataGenerator.generateArray(N, true, false);	// decreasing array
	...
	public static <T extends Comparable<? super T>>
					void doSort(SortType type, T [] ary)
	{
		StopWatch timer = new StopWatch();
		timer.start();
