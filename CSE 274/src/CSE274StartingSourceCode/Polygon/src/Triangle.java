...
public class Triangle {    
    ...
    /**
     * Constructs a right triangle with the following
     ...
     * @param A The first vertex of triangle
     * @param B The second vertex of triangle
     * @param C The third vertex of triangle
     */
    ...
    /**
     * Copy constructor
     * @param tri The triangle to be copied.
     */
    ...
    public String toString() {
    	return String.format("[%s;%s;%s]", a.toString(),
    										b.toString(),
    										c.toString());
    }
    ...
    /**
     * Determines if the given triangle is larger (in area) than
     * the passed triangle
     * @param tri The second triangle
    ...
    /**
     * Returns whether two double precision numbers are "equivalent".
     * Where equivalent is defined as "being with 0.001 of eachother".
     * @param a One of the values being compared
     * @param b The other values being compared
