...
public class Point {
    ...
    /**
     * Constructs a point with specific position
     ...
     * @param text The point's string representation
    ...
    */
     ...
     * @param p The second point in the comparison
    ...
    /**
     * Translates the point by given x and y deltas
     * @param deltaX How much to change the x coordinate by
     * @param deltaY How much to change the y coordinate by
     */
